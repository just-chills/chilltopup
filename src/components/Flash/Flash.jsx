        ...
        <div className='w-full px-[12px] mx-[280px] '>
          ...
          <div>
            ...
            <div className='flex flex-wrap w-full h-full'>
                  ...
                  <div className='z-[5] h-[33.33333%] top-[unset] min-h-[200px] p-[20px] items-start pointer-events-auto absolute rounded-[inherit] flex justify-center left-0 right-0 bottom-0 transition-[all,z-index] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] '>
                    ...
                    <div className='opacity-[0.5] bg-[#000] border-[#000] rounded-[inherit] h-full w-full absolute transition-[inherit] will-change-[opacity] '></div>
                      ...
                      <div className='w-full h-full relative  whitespace-normal break-words mt-4'>
                        <div className='mr-4 text-[#fff] font-DBheavent text-[22px] leading-[24px] min-h-[28px] flex items-center gap-2'>
                          <span>SALE NOW</span>
                          {/* chip */}
                          <CountdownChip />
                        </div>
                        {/* card_promotion_title */}
                        <h3 className=' text-[#fff] text-[32px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[28px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}>VALORANT</h3>
                        <h4 className='flex text-[#fff] text-[24px] leading-[28px] font-DBheavent font-bold w-full min-h-[28px]' style={{'unicodeBidi': 'isolate' }}>
                        ...
                        <p className=' text-[#fff] text-[20px] leading-[28px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>1000 VP</p>
                        <div className='flex w-full h-full'>
                          <div className='max-w-[50%] flex-[1_1_auto]'>
                            ...
                            {/* caption */}
                            <div className='mt-2 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent '> 997 LEFT </div>
                            {/* card promotion action */}
                            <div className='z-[6] flex flex-wrap gap-2 w-auto items-center justify-end absolute bottom-2 right-2'>
                              <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                                <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-10 min-w-[90px] sm:min-w-[100px] font-DBheavent text-base sm:text-[22px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'>Top Up</span>
                              </a>
                              <button className='bg-white h-[40px] w-[40px] cursor-pointer rounded-full items-center inline-flex font-medium justify-center bg-transparent border-none'>
                              ...
                              <button className='mx-2 bg-white h-[40px] w-[40px] cursor-pointer rounded-full items-center align-middle inline-flex font-medium justify-center bg-transparent border-none'>
                                <span>
                                  <img className='w-6 h-6' src="//icons.veryicon.com/png/o/miscellaneous/home-ams-icon-library/ic_share.png" alt="gameon" />
                                </span>
                              </button>
                            </div>
                          </div>
              ...
              {/* col-md-6 col-12 */}
              <div className='px-2 py-2 z-[1] w-full sm:w-1/2  max-w-full'>
                {/* contain-merge */}
                <div className='aspect-[1/1] overflow-hidden bottom-0 relative rounded-[0px] border-[thin] block max-w-full outline-none decoration-[none] transition-[box-shadow,opacity] break-words whitespace-normal'>
                  {/* card */}
                  <div className='mb-2 aspect-[unset] overflow-hidden bg-[#1e1e1e] text-[#fff] rounded-none border-[#1e1e1e] border-[thin] block max-w-100% outline-none transition-[opacity,box-shadow] relative whitespace-normal' style={{'height': 'calc(50% - 8px)', 'textDecoration': 'none'}}>
                    {/* row */}
                    <div className='m-0 flex flex-wrap flex-[1_1_auto] h-full w-full'>
                      {/* col col-6 */}
                      ...
                      {/* col col-6 */}
                      <div className='p-4 z-[1] flex-[0_0_50%] max-w-[50%]'>
                        {/* promotion-inner */}
                        <div className='w-full h-full relative flex flex-col gap-2 whitespace-normal break-words mt-4'>
                          <div className='mr-2 text-[#fff] font-DBheavent text-[22px] leading-[28px] min-h-[28px] flex items-center gap-2'>
                            <span> SALE NOW </span>
                            {/* chip */}
                            <CountdownChip />
                          </div>
                          {/* card-promotion-title */}
                          <h3 className=' text-[#fff] text-[20px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> EA SPORTS FC™ MOBILE 24 </h3>
                          <h4 className='flex text-[#fff] text-[24px] leading-[28px] font-DBheavent font-bold w-full min-h-[28px]' style={{'unicodeBidi': 'isolate' }}>
                            <span className='line-through decoration-[red]'>฿179</span>
                              <p className='mx-4 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                            <span className='text-primary'>฿170.05</span>
                          </h4>
                          <p className='text-[#fff] text-[20px] leading-[28px] font-DBheavent mb-0 w-full min-h-[28px] truncate'> 520 FC POINTS </p>
                          ...
                          {/* captions */}
                          <div className='mt-1 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent '> 1000 LEFT </div>
                          {/* card_promotion_action */}
                          <div className='z-[6] flex flex-wrap gap-4 w-auto items-center justify-end absolute bottom-4 right-2'>
                            <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                              <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-10 min-w-[90px] sm:min-w-[100px] font-DBheavent text-base sm:text-[22px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'> Top Up </span>
                            </a>
                            <button className='bg-white h-[40px] w-[40px] cursor-pointer rounded-full items-center inline-flex font-medium justify-center bg-transparent border-none'>
                            ...
                            <button className='mx-2 bg-white h-[40px] w-[40px] cursor-pointer rounded-full items-center align-middle inline-flex font-medium justify-center bg-transparent border-none'>
                              <span>
                                <img className='w-6 h-6 items-center align-middle justify-center' src="//icons.veryicon.com/png/o/miscellaneous/home-ams-icon-library/ic_share.png" alt="gameon" />
                              </span>
                            </button>
                          </div>
                        </div>
                    ...
                    <div className='m-0 flex flex-wrap flex-[1_1_auto] h-full w-full'>
                      ...
                      <div className='p-4 z-[1] flex-[0_0_50%] max-w-[50%] '>
                        ...
                        <div className='w-full h-full relative flex flex-col gap-2 whitespace-normal break-words mt-4'>
                          ...
                          {/* card_promotion_title */}
                          <h3 className=' text-[#fff] text-[32px] leading-[28px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> Genshin Impact </h3>
                          <h4 className='flex text-[#fff] text-[24px] leading-[28px] font-DBheavent font-bold w-full min-h-[28px]' style={{'unicodeBidi': 'isolate' }}>
                            <span className='line-through decoration-[red] '>฿153</span>
                              <p className='mx-4 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                            <span className='text-primary'>฿142.29</span>
                          </h4>
                          <p className='text-[#fff] text-[20px] leading-[28px] font-DBheavent mb-0 w-full min-h-[28px] truncate'> Blessing of the Welkin Moon </p>
                          <div className='flex w-full'>               
                            <div className='max-w-[50%] flex-[1_1_auto]'>
                              {/* progress bar */}
                              <div className='h-1 border-[#fff] border-solid border-[3px] rounded-[4px] bg-transparent relative overflow-hidden w-full transition-[all] ease-[cubic-bezier(0.4,0,0.6,1)] duration-[0.2s] delay-0'></div>
                          ...
                          {/* captions */}
                          <div className='mt-1 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent'> 999 LEFT </div>
                          {/* card_promotion_action */}
                          <div className='z-[6] flex flex-wrap gap-4 w-auto items-center justify-end absolute bottom-4 left-2'>
                            <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                              <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-10 min-w-[90px] sm:min-w-[100px] font-DBheavent text-base sm:text-[22px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'> Top Up </span>
                            </a>
                            <button className='bg-white h-[40px] w-[40px] cursor-pointer rounded-full items-center inline-flex font-medium justify-center bg-transparent border-none'>
                ...
                <div className='aspect-square overflow-hidden bottom-0 relative rounded-[0px] border-[thin] block max-w-full outline-none decoration-[none] transition-[box-shadow,opacity] break-words whitespace-normal'>
                  ...
                  <div className='z-[5] h-[33.33333%] top-[unset] min-h-[200px] p-[20px] items-start pointer-events-auto absolute rounded-[inherit] flex justify-center left-0 right-0 bottom-0 transition-[all,z-index] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s]'>
                    ...
                    <div className='w-full h-full relative  whitespace-normal break-words mt-2'>
                      <div className='mr-4 text-[#fff] font-DBheavent text-[22px] leading-[22px] min-h-[28px] flex items-center gap-2'>
                        <span> SALE NOW </span>
                        {/* chip */}
                        <CountdownChip />
                      </div>
                      {/* card-promotion-title */}
                      <h3 className='text-[#fff] text-[22px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}>Harry Potter: Magic Awakened</h3>
                      <h4 className='flex text-[#fff] text-[22px] leading-[22px] font-DBheavent font-bold w-full min-h-[30px]' style={{'unicodeBidi': 'isolate' }}>
                        <span className='line-through decoration-[red]'>฿179</span>
                          <p className='mx-2 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                        <span className='text-primary'>฿148.57</span>
                      </h4>
                      <p className='text-[#fff] text-[20px] leading-[22px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>300 Jewels</p>
                      <div className='flex w-full h-full'>
                        <div className='max-w-[50%] flex-[1_1_auto]'>
                          {/* progress bar */}
                          ...
                          {/* captions */}
                          <div className='mt-2 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent'> 1000 LEFT </div>
                        </div>
                      </div>
                    </div>
                  </div>
                  ...
                  <div className='z-[6] flex flex-wrap gap-2 w-auto items-center justify-end absolute bottom-2 right-2'>
                    <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                      <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-8  sm:min-w-[60px] font-DBheavent text-base sm:text-[12px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'> Top Up </span>
                    </a>
                ...
                <div className='aspect-square overflow-hidden bottom-0 relative rounded-[0px] border-[thin] block max-w-full outline-none decoration-[none] transition-[box-shadow,opacity] break-words whitespace-normal'>
                  ...
                  <div className='z-[5] h-[33.33333%] top-[unset] min-h-[200px] p-[20px] items-start pointer-events-auto absolute rounded-[inherit] flex justify-center left-0 right-0 bottom-0 transition-[all,z-index] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s]'>
                    ...
                    <div className='w-full h-full relative  whitespace-normal break-words mt-2'>
                      ...
                      {/* card-promotion-title */}
                      <h3 className='text-[#fff] text-[22px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> Onmyoji Arena </h3>
                      <h4 className='flex text-[#fff] text-[22px] leading-[22px] font-DBheavent font-bold w-full min-h-[30px]' style={{'unicodeBidi': 'isolate' }}>
                        <span className='line-through decoration-[red] '>฿300</span>
                          <p className='mx-2 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                        <span className='text-primary'>฿249</span>
                      </h4>
                      <p className='text-[#fff] text-[20px] leading-[22px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>Jade 680</p>
                      <div className='flex w-full h-full'>
                        <div className='max-w-[50%] flex-[1_1_auto]'>
                          {/* progress bar */}
                          <div className='h-1 border-[#fff] border-solid border-[3px] rounded-[4px] bg-transparent relative overflow-hidden w-full transition-[all] ease-[cubic-bezier(0.4,0,0.6,1)] duration-[0.2s] delay-0'>
                ...
                <div className='aspect-square overflow-hidden bottom-0 relative rounded-[0px] border-[thin] block max-w-full outline-none decoration-[none] transition-[box-shadow,opacity] break-words whitespace-normal'>
                  ...
                  <div className='z-[5] h-[33.33333%] top-[unset] min-h-[200px] p-[20px] items-start pointer-events-auto absolute rounded-[inherit] flex justify-center left-0 right-0 bottom-0 transition-[all,z-index] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s]'>
                    ...
                    <div className='w-full h-full relative  whitespace-normal break-words mt-2'>
                      ...
                      <h3 className='text-[#fff] text-[22px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> League of Legends (PC) </h3>
                      <h4 className='flex text-[#fff] text-[22px] leading-[22px] font-DBheavent font-bold w-full min-h-[30px]' style={{'unicodeBidi': 'isolate' }}>
                        <span className='line-through decoration-[red]'>฿290</span>
                          <p className='mx-2 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                        <span className='text-primary'>฿275.5</span>
                      </h4>
                      <p className='text-[#fff] text-[20px] leading-[22px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>LoL - 1380RP</p>
                      <div className='flex w-full h-full'>
                        <div className='max-w-[50%] flex-[1_1_auto]'>
                          {/* progress bar */}
                          <div className='h-1 border-[#fff] border-solid border-[3px] rounded-[4px] bg-transparent relative overflow-hidden w-full transition-[all] ease-[cubic-bezier(0.4,0,0.6,1)] duration-[0.2s] delay-0'>
                          ...
                          {/* captions */}
                          <div className='mt-2 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent'> 990 LEFT </div>
                        </div>
                      </div>
                    </div>
                  </div>
            ...
            <div className='flex flex-wrap flex-[1_1_auto] h-full w-full'>
              ...
              <div className='px-2 py-2 z-[1] w-full sm:w-1/2 max-w-full'>
                ...
                <div className='mb-2 overflow-hidden bg-[#1e1e1e] text-[#fff] rounded-none border-[#1e1e1e] border-[thin] block outline-none transition-[opacity,box-shadow] relative whitespace-normal'>
                  ...
                  <div className='flex flex-wrap flex-[1_1_auto] h-full w-full'>
                    ...
                    {/* col-6 */}
                    <div className='p-2 z-[1] w-1/2'>
                      {/* promotion_inner */}
                      <div className='w-full h-full relative flex flex-col gap-1 whitespace-normal break-words'>
                        <div className='mr-2 text-[#fff] font-DBheavent text-[22px] leading-[28px] min-h-[28px] flex items-center gap-2'>
                          <span> SALE NOW </span>
                          {/* chip */}
                          <CountdownChip />
                        </div>
                        <h3 className='text-[#fff] text-[20px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> Eggy Party </h3>
                        <h4 className='flex text-[#fff] text-[24px] leading-[28px] font-DBheavent font-bold w-full min-h-[28px]' style={{'unicodeBidi': 'isolate' }}>
                          <span className='line-through decoration-[red]'>฿60</span>
                            <p className='mx-4 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                          <span className='text-primary'>฿49.8</span>
                        </h4>
                        <p className='text-[#fff] text-[20px] leading-[28px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>120 eggy coins</p>
                        <div className='flex w-full'>
                          <div className='max-w-[50%] flex-[1_1_auto]'>
                            {/* progress bar */}
                            <div className='h-1 border-[#fff] border-solid border-[3px] rounded-[4px] bg-transparent relative overflow-hidden w-full transition-[all] ease-[cubic-bezier(0.4,0,0.6,1)] duration-[0.2s] delay-0'></div>
                        ...
                        {/* captions */}
                        <div className='mt-1 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent'> 1000 LEF </div>
                        {/* card_promotion_action */}
                        <div className='z-[6] flex flex-wrap gap-2 w-auto items-center justify-end absolute bottom-4 right-2'>
                          <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                            <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-8  sm:min-w-[60px] font-DBheavent text-base sm:text-[12px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'> Top Up </span>
                          </a>
                          <button className='bg-white h-[30px] w-[30px] cursor-pointer rounded-full items-center inline-flex font-medium justify-center bg-transparent border-none'>
              ...
              {/* col-12 */}
              <div className='px-2 py-2  z-[1] w-full sm:w-1/2 '>
                {/* card */}
                <div className='mb-2 overflow-hidden bg-[#1e1e1e] text-[#fff] rounded-none border-[#1e1e1e] border-[thin] block outline-none transition-[opacity,box-shadow] relative whitespace-normal'>
                  {/* row */}
                  <div className='m-0 flex flex-wrap flex-[1_1_auto] h-full w-full'>
                    {/* col-6 */}
                    <div className='p-2 z-[1] flex-[0_0_50%] max-w-[50%]'>
                      {/* promotion_inner */}
                      <div className='w-full h-full relative flex flex-col gap-1 whitespace-normal break-words'>
                        <div className='mr-2 text-[#fff] font-DBheavent text-[22px] leading-[28px] min-h-[28px] flex items-center gap-2'>
                          <span> SALE NOW </span>
                        ...
                        <h3 className='text-[#fff] text-[20px] leading-[38px] font-DBheavent font-bold overflow-hidden truncate w-full min-h-[38px]' style={{ '-webkit-line-clamp': '2', 'display': '-webkit-box', '-webkit-box-orient': 'vertical' }}> TFT: Teamfight Tactics </h3>
                        <h4 className='flex text-[#fff] text-[24px] leading-[28px] font-DBheavent font-bold w-full min-h-[28px]' style={{'unicodeBidi': 'isolate' }}>
                          <span className='line-through decoration-[red]'>฿290</span>
                            <p className='mx-4 items-center inline-flex text-[14px] justify-center relative align-middle transition-[all,visibility] ease-cubic-bezier(0.25,0.8,0.5,1) duration-[0.3s,0s] delay-0' style={{'fontFeatureSettings': 'liga', 'letterSpacing': 'normal', 'lineHeight': '1', 'textIndent': '0', 'userSelect': 'none'}}>{'>'}</p>
                          <span className='text-primary'>฿275.5</span>
                        </h4>
                        <p className='text-[#fff] text-[20px] leading-[28px] font-DBheavent mb-0 w-full min-h-[28px] truncate'>1380 TFT Coins</p>
                        <div className='flex w-full'>
                          <div className='max-w-[50%] flex-[1_1_auto]'>
                            {/* progress bar */}
                            <div className='h-1 border-[#fff] border-solid border-[3px] rounded-[4px] bg-transparent relative overflow-hidden w-full transition-[all] ease-[cubic-bezier(0.4,0,0.6,1)] duration-[0.2s] delay-0'></div>
                        ...
                        {/* captions */}
                        <div className='mt-1 text-[#8f8f8f] text-[20px] leading-[22px] font-DBheavent'> 998 LEFT </div>
                        {/* card_promotion_action */}
                        <div className='z-[6] flex flex-wrap gap-4 w-auto items-center justify-end absolute bottom-4 left-2'>
                          <a href="https://gameon.ais.co.th/games/valorant-pid-633ff5c7077a1c0012aecbf4">
                            <span className='mx-2 bg-[rgba(8,8,8,0.5)] border-primary border-[1px] h-8  sm:min-w-[60px] font-DBheavent text-base sm:text-[12px] leading-[22px] text-[#fff] rounded-[8px] flex items-center justify-center cursor-pointer'> Top Up </span>
                          ...
                          <button className='mx-2 bg-white h-[30px] w-[30px] cursor-pointer rounded-full items-center align-middle inline-flex font-medium justify-center bg-transparent border-none'>
                            <span>
                              <img className='-4 h-4 items-center align-middle justify-center' src="//icons.veryicon.com/png/o/miscellaneous/home-ams-icon-library/ic_share.png" alt="gameon" />
                            </span>
                          </button>
                        </div>
                      </div>
